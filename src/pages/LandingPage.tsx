...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-x-hidden overflow-y-auto">
            {/* -- HEADER -- */}
            ...
            <section ref={aboutRef} className="reveal max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 text-center">
                <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                    About <span className="text-blue-400">NOMOS AI</span>
                </h2>
                <p className="text-gray-400 text-lg leading-relaxed max-w-3xl mx-auto">
                    NOMOS AI is a super-intelligent global legal assistant that delivers direct, comprehensive
            ...
            <section ref={faqRef} className="reveal max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                ...
                <p className="text-gray-400 text-center mb-12 max-w-xl mx-auto">
                    Everything you need to know about NOMOS AI
                </p>
            ...
            <footer id="footer" ref={footRef} className="reveal border-t border-gray-800 bg-gray-900/60">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} NOMOS AI. All rights reserved.</p>
