...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0e1a] text-[#e8e6e0] font-sans antialiased flex items-center justify-center p-4">
            ...
            <div className="orb w-[420px] h-[420px] -top-32 -left-24 bg-gradient-to-br from-[#c9a961]/25 via-[#c9a961]/10 to-transparent" />
            <div className="orb w-[360px] h-[360px] -bottom-32 -right-24 bg-gradient-to-tr from-[#4a5a8a]/20 via-[#2a3a6a]/10 to-transparent" />
