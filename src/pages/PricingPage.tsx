    ...
    return (
        <div className="min-h-screen bg-[#0a0e1a] text-[#e8e6e0] font-sans antialiased">
            ...
            <div className="relative">
                <div className="orb w-[420px] h-[420px] -top-40 -right-32 bg-gradient-to-br from-[#3b82f6]/25 via-[#3b82f6]/10 to-transparent" />
                <div className="orb w-[360px] h-[360px] top-[420px] -left-40 bg-gradient-to-tr from-[#7c3aed]/20 via-[#06b6d4]/10 to-transparent" />
                <div className="orb w-[300px] h-[300px] bottom-0 right-1/4 bg-gradient-to-t from-[#3b82f6]/15 to-transparent" />
            </div>
            ...
            <header className="sticky top-0 z-40 bg-[#0a0e1a]/90 backdrop-blur-lg border-b border-[#1a2030]">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <Link to="/" className="flex items-center gap-2.5 group">
                        <div className="relative flex items-center justify-center h-9 w-9 rounded-full blue-gradient shadow-lg shadow-[#3b82f6]/20 group-hover:shadow-[#3b82f6]/40 transition-shadow">
                            <Scale className="h-4.5 w-4.5 text-white" strokeWidth={2} />
                        </div>
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
                ...
                <div ref={titleRef} className="reveal text-center mb-14">
                    <div className="inline-flex items-center gap-2 text-[#3b82f6] text-xs font-semibold tracking-[0.2em] uppercase mb-6">
                ...
                <div ref={toggleRef} className="reveal flex items-center justify-center gap-4 mb-16">
                    ...
                    <button
                        ...
                        className="relative w-14 h-7 rounded-full bg-[#0f1420] border border-[#2a3142] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#3b82f6]"
                        aria-label="Toggle billing period"
                    >
                        <div
                            className={`absolute top-0.5 w-6 h-6 rounded-full blue-gradient shadow-md shadow-[#3b82f6]/30 transition-all duration-300 ${
                    ...
                    {isYearly && (
                        <span className="text-xs text-white blue-gradient px-3 py-1 rounded-full font-semibold tracking-wide shadow-md shadow-[#3b82f6]/25">
                            Save up to 18%
                        </span>
                    )}
                </div>
                        ...
                        return (
                            <div
                                ...
                                className={`relative flex flex-col p-8 lg:p-9 rounded-3xl transition-all duration-300 ${
                                    plan.popular
                                        ? 'bg-gradient-to-b from-[#1a2030] to-[#0f1420] border border-[#3b82f6]/40 shadow-2xl shadow-[#3b82f6]/10 md:scale-105'
                                        : 'bg-[#0f1420]/60 border border-[#1a2030] hover:border-[#2a3142] hover:-translate-y-1'
                                }`}
                            >
                                {plan.popular && (
                                    <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 blue-gradient text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-lg shadow-[#3b82f6]/30 tracking-wide">
                                        Most Chosen
                                    </span>
                                )}

                                <p className="text-[#3b82f6]/70 font-serif text-sm mb-5">{plan.mark}</p>
                                ...
                                <div className="mb-8">
                                    ...
                                    {isYearly && (
                                        <p className="text-[#3b82f6] text-sm font-medium mt-2">
                                ...
                                <ul className="space-y-3 mb-9 flex-1">
                                    {plan.features.map((feat) => (
                                        <li key={feat} className="flex items-start gap-2.5 text-sm text-[#8b92a8] leading-relaxed">
                                            <span className="flex items-center justify-center h-4.5 w-4.5 rounded-full bg-[#3b82f6]/15 flex-shrink-0 mt-0.5">
                                                <Check className="h-3 w-3 text-[#3b82f6]" strokeWidth={2.5} />
                                            </span>
                                            {feat}
                                        </li>
                                    ))}
                                ...
                                <button
                                    ...
                                    className={`w-full font-semibold py-3.5 rounded-full transition-all duration-200 hover:scale-[1.02] ${
                                        plan.popular
                                            ? 'blue-gradient text-white shadow-lg shadow-[#3b82f6]/25 hover:shadow-xl hover:shadow-[#3b82f6]/35'
                                            : 'border border-[#2a3142] hover:border-[#3b82f6]/60 text-[#e8e6e0]'
                                    }`}
                                >
                                    Choose {plan.name}
                                </button>
