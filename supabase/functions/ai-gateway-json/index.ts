...
serve(async (req: Request) => {
  ...
  try {
    ...
    console.error('[ai-gateway-json] Gemini failed, falling back to DeepSeek:', geminiError.message);
    ...
    try {
      ...
      console.error('[ai-gateway-json] DeepSeek fallback also failed:', deepSeekError.message);
      return new Response(
